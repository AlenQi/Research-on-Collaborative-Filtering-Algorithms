...
1. [相关领域国内外应用的现状及发展趋势](##相关领域国内外应用的现状及发展趋势)
1. [推荐系统及协同过滤简介](##推荐系统及协同过滤简介)
   1. [推荐系统](#推荐系统)
   2. [协同过滤](协同过滤)
1. [实验设计和算法测评](#实验设计和算法测评)
1. [引言](#引言)
1. [数据集](#数据集)
1. [实验设计](#实验设计)
1. [算法测评](#算法测评)
...
1. [基础算法](#基础算法)
1. [相似度算法的改进](#相似度算法的改进)
1. [基于物品的协同过滤算法](#基于物品的协同过滤算法)
1. [引言](#引言)
1. [基础算法](#基础算法)
1. [用户活跃度和物品相似度关系](#用户活跃度和物品相似度关系)
1. [UserCF 和 ItemCF 的比较](#UserCF和ItemCF的比较)
1. [引言](#引言)
1. [UserCF 和 ItemCF 的综合比较](#UserCF和ItemCF的综合比较)
...
<small class="img-hint">图 1.1 推荐系统</small>
...
<small class="img-hint">图 1.3 淘宝足球鞋推荐</small>
...
<small class="img-hint">图 3.4 UserCF 算法和 User-IIF 算法的对比</small>
...
<small class="img-hint">图 4.3 一个简单的基于物品推荐的例子</small>
...
<small class="img-hint">图 4.5 ItemCF 算法和 ItemCF-IUF 算法的对比</small>
...
- [2] 张娜．电子商务环境下的个性化信息推荐服务及应用研究[D]．合肥工业大学， 2007 -[3] Dietmar Jannach，Markus Zanker，Alexander Felfernig．Recommender Systems[M]．蒋凡译．人民邮电出版社．2013
